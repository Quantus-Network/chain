...
impl From<litep2p::protocol::notification::Direction> for traits::Direction {
	fn from(direction: litep2p::protocol::notification::Direction) -> traits::Direction {
		match direction {
			litep2p::protocol::notification::Direction::Inbound => traits::Direction::Inbound,
			litep2p::protocol::notification::Direction::Outbound => traits::Direction::Outbound,
		}
	}
}
