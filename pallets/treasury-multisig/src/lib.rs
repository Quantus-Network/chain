...
sp_api::decl_runtime_apis! {
	/// API to query treasury multisig configuration
	pub trait TreasuryMultisigApi<AccountId> where AccountId: codec::Codec {
		/// Get the computed treasury multisig account address
		fn get_treasury_account() -> AccountId;
		/// Get the list of signatories
		fn get_signatories() -> alloc::vec::Vec<AccountId>;
