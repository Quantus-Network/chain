...
mod benchmarks {
    ...
    fn claim() {
        ...
        <T::Currency as Mutate<T::AccountId>>::set_balance(&MerkleAirdrop::<T>::account_id(), large_balance);
        ...
        #[extrinsic_call]
        claim(RawOrigin::Signed(caller), airdrop_id, recipient, amount, merkle_proof);
    }
