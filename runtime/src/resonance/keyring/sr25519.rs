...
impl Keyring {
    ...
    pub fn from_account_id(who: &ResonanceAccountId) -> Option<Keyring> {
    ...
    pub fn to_account_id(self) -> ResonanceAccountId {
    ...
    pub fn numeric_id(idx: usize) -> ResonanceAccountId {
...
impl From<Keyring> for ResonanceAccountId {
    fn from(k: Keyring) -> Self {
        k.to_account_id()
    }
}
