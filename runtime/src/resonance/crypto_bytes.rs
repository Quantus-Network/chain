...
// use crate::{
// 	resonance::account::{CryptoType, Derive, FromEntropy, Public, Signature, UncheckedFrom},
// 	hash::{H256, H512},
// };
use resonance::account::{CryptoType,Derive,FromEntropy,Public,Signature,UncheckedFrom};
...
#[cfg(feature = "serde")]
use resonance::account::Ss58Codec;
#[cfg(feature = "serde")]
...
pub mod public_bytes {
	...
	use crate::resonance::account::PublicError;
	use super::*;
		...
		Self: CryptoType,
	{
		...
		fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
			...
			write!(f, "{} ({}...)", hexdisplay::HexDisplay::from(&self.as_ref()), &s[0..8])
		}
