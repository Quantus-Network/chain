...
pub struct RsaShortcutMath;

impl RsaShortcutMath {
    ...
    pub fn get_nonce_distance(
        ...
        let original_chunks = Self::hash_to_group_bigint_split(&header_int, &m, &n, &U512::zero());

        // Compare PoW results
        let nonce_chunks = Self::hash_to_group_bigint_split(&header_int, &m, &n, &nonce_int);
